...
```cmd
python test_automation.py --excel "IT23635548.xlsx" --url "https://www.pixelssuite.com/chat-translator" --wait-ms 5000 --type-delay-ms 80 --slow-mo-ms 200 --save-every 1 --keep-open
```

The script will:
- Read the test cases from the Excel file (`IT23635548.xlsx`).
